					...
					<div class="blog-masonry clearfix">
						...
						<div class="grid-item grid-item-width-2x">
							<div class="post-entry-card post-entry-featured">
								<a href="#"><img src="images/drone-training.png"
									class="img-responsive" alt="Post Thumbnail"> </a>
								<div class="post-info">
									<h3 class="post-title">
										<a href="#">Drone Pilot Training Certificate</a>
									</h3>
									<p class="post-excerpt">The objective of this training program
										is to provide a quick start to drone piloting with the MAVLink
										protocol. Learning how to pilot drone and define autonomous
										mission is very challenging and time consuming. There is a
										huge amount of informtaion to know, yet this information is
										very scattered on the Internet. By attending the 13-hour
										training sessions, the participant will have a full
										understanding of drone technologies, and will have the ability
										to build hos own drone, and enjoy piloting it either with a
