        ...
        <!-- ADD FORMS FOR CONFERENCE AND PROJECT -->
          ...
          <!-- ADD FORM FOR CONFERENCE -->
            ...
            <div class="form-group">
						...
						<button type="button" class="btn btn-primary btn-lg center-block" onclick="addRequest()"><i class="fa fa-sign-in"></i> ADD</button>
            <p id="added" class="">
					</form>
          ...
          <!-- REMOVE FORM FOR CONFERENCE -->
					...
					<?php echo $_SERVER["PHP_SELF"];?> method="get" style="display: none;">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control cinput" id="cname"
									name="name">
          ...
          <form class="form-horizontal label-left" id="projectRemoveForm"
					<?php echo $_SERVER["PHP_SELF"];?> method="get" style="display: none;">
						...
						<div class="form-group">
							<label for="remove-name" class="col-sm-3 control-label">Name*</label>
							<div class="col-sm-9">
								<input type="text" class="form-control pinput" id="pname"
									name="name">
        ...
        <div class="well well-form-wrapper col-sm-12">
          ...
          <!-- ENTER TARGET CONFERENCE/PROJECT TO BE UPDATED -->
					...
					<?php echo $_SERVER["PHP_SELF"];?> method="get">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control cinput" id="updatecname"
									name="name">
                <p id="used5" class="" style="display:none;"></p>
							</div>
						</div>

						<button type="button" class="btn btn-primary btn-lg center-block" onclick="displayRequest()"><i class="fa fa-sign-out"></i> DISPLAY INFO</button>
            <p id="updated" class="">
					</form>
          ...
          <?php echo $_SERVER["PHP_SELF"];?> method="get" style="display: none;">
            ...
            <div class="form-group">
              <label for="update-name" class="col-sm-3 control-label">Name*</label>
              <div class="col-sm-9">
                <input type="text" class="form-control cinput" id="update-name"
                  name="name">
            ...
            <button type="button" class="btn btn-primary btn-lg center-block" onclick="updateRequest()"><i class="fa fa-sign-in"></i> UPDATE</button>
            <p id="updated2" class="">
          </form>
