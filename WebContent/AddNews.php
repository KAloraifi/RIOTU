...
if ($result->num_rows == 1) {
    ...
    $sql1="INSERT INTO news (title, shortDescription, longDescription, date, picture1, picture2, picture3, picture4, author ) VALUES ('".$title."', '".$shortDescription."', '".$longDescription."', '".$date."', '".$picture1."', '".$picture2."', '".$picture3."', '".$picture4."', '".$author."')";
    $conn->query($sql1);
