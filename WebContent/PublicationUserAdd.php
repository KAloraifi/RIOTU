...
if ($result->num_rows == 1) {
    ...
    $sql1="INSERT INTO publication (title, impactfactor, year, month, pages, publisher, issue, volume, category, indexing, booktitle, hlink, author) VALUES ('".$title."', '".$impactfactor."', '".$year."', '".$month."', '".$pages."', '".$publisher."', '".$issue."', '".$volume."', '".$category."', '".$indexing."', '" .$booktitle."', '".$hlink."', '".$_SESSION["firstname"].$_SESSION["lastname"]."')";
    //echo $sql1;
    $conn->query($sql1);
