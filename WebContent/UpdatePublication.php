...
if ($result->num_rows == 1) {
 ...
 $sql = "UPDATE publication SET title='".$title."',impactfactor='".$impactfactor."',year='".$year."',month='".$month."',pages='".$pages."',publisher='".$publisher."',issue='".$issue."',volume='".$volume."',category='".$category."',indexing='".$indexing."',booktitle='".$booktitle."',hlink='".$hlink."' WHERE title='".$_SESSION["titleupdate"]."';" ;
echo"<response>";
