                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="dashboard/pub.php" class="btn-box big span4"><i class="fa fa-book" aria-hidden="true"></i><b>
                                    ...
                                    <a href="dashboard/users.php" class="btn-box big span4"><i class="fa fa-users" aria-hidden="true"></i><b>
                                    ...
                                    <a href="dashboard/proj.php" class="btn-box big span4"><i class="fa fa-money" aria-hidden="true"></i><b>
                                ...
                                <div class="btn-box-row row-fluid">
                                    <div class="span8">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="dashboard/users.php" class="btn-box small span4"><i class="fa fa-users" aria-hidden="true"></i><b>Users</b>
                                                </a><a href="dashboard/pub.php" class="btn-box small span4"><i class="fa fa-book" aria-hidden="true"></i><b>Publications</b>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="dashboard/proj.php" class="btn-box small span4"><i class="fa fa-tasks" aria-hidden="true"></i><b>Projects</b>
                                                </a><a href="dashboard/news.php" class="btn-box small span4"><i class="fa fa-newspaper-o" aria-hidden="true"></i><b>News</b>
