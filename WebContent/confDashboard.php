...
<body>
	...
	?>
		...
		<div class="page-header">
			<div class="container">
				<h1 class="page-title pull-left">Conferences Management</h1>
        ...
        <a href="dashboard.php"><button type="button" style="font-size: 16px; border-radius: 12px; float: right; margin-right:50px;">Manage Conferences</button></a>
        <?php 
include_once 'include/headers_links.php';
